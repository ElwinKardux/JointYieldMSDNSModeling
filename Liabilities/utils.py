...
def comp_m_i(t,T_imin, T_i, NominalMarketPrice_T_imin, NominalMarketPrice_T_i, NominalMarketPrice_t, RealMarketPrice_T_imin, RealMarketPrice_T_i, RealMarketPrice_t,  a_n, a_r, sigma_n, sigma_I, sigma_r, rho_nr, rho_rI):
    """
    mean function, page 662. Important add on:  The book does not say anything, but the
    formula only works for t < T_{i-1}.  When t = T_{i-1}, you will get values of
    infinity, hence I looked up more on it, and the book did say something about in the
    Swap pricing section, but not in the option pricing section.  It came down to the
    adjustment in the if statement below, or page 653 Mercurio. 
    ...
    m_i = (P_n_1 / P_n_2) * (P_r_1 / P_r_2) * np.exp(C) + 0.02
    # print('P_n_1',P_n_1)
    # print('P_n_2',P_n_2)
    # print('P_r_1',P_r_1)
    # print('P_r_2',P_r_2)
